...
class BaseSinfonierBolt(storm.BasicBolt):
                    ...
                    if subelt.tag not in excludedparams:
                      ...
                      if len(subelt):
                        ...
                        if subelt.tag in self.config.keys():
                          ...
                          # lo convertimos a lista y add el nuevo
  ...
  def process(self,tup):
    ...
    self.lastuple = tup
    self.d = json.loads(tup.values[1])
